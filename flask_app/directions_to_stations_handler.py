...
def add_paths_to_station(source_latitude, source_longitude, station, iteration, max_iterations):
    """
    ...
    coordinates = [[source_longitude, source_latitude], [station_longitude, station_latitude]]
